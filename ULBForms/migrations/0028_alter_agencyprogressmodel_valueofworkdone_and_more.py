...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ULBForms', '0027_alter_agencyprogressmodel_valueofworkdone_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=8, null=True, verbose_name='Value of Work done (in lakhs)'),
        ),
        migrations.AlterField(
